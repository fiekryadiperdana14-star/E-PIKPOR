...
('admin', '${adminPass}', 'Administrator Sistem', '-', '-', 'admin', NULL, NULL),
('fiekry.adi', '${defaultPass}', 'FIEKRY ADI PERDANA, S.I.Kom.', 'AKP', '-', 'kanit', NULL, NULL),
('agret.devia', '${defaultPass}', 'AGRET DEVIA PRATIWI PUTRI', 'BRIPTU', '-', 'bamin', NULL, NULL),
('mutiara.maulina', '${defaultPass}', 'MUTIARA MAULINA DEWI', 'BRIPDA', '-', 'bamin', NULL, NULL),
('sucipto.ari', '${defaultPass}', 'SUCIPTO ARI WARDANI, S.A.P., M.A.P.', 'IPDA', '-', 'kasubnit', 1, NULL),
('sari.wulandari', '${defaultPass}', 'SARI WULANDARI A., S.H., CPHR.', 'IPDA', '-', 'kasubnit', 3, NULL),
('watchid.khomarudin', '${defaultPass}', 'WATCHID KHOMARUDIN', 'AIPDA', '-', 'danregu', 1, 1),
('dani.timur', '${defaultPass}', 'DANI', 'AIPDA', '-', 'anggota', 1, 1),
('ganepa.cahya', '${defaultPass}', 'GANEPA CAHYA FIRDAUS, S.H.', 'BRIPKA', '-', 'danregu', 1, 2),
('bambang.timur', '${defaultPass}', 'BAMBANG', 'AIPDA', '-', 'anggota', 1, 2),
('ibnu.narowi', '${defaultPass}', 'IBNU NAROWI, S.H.', 'AIPTU', '-', 'danregu', 1, 3),
('siegit.dwi', '${defaultPass}', 'SIEGIT DWI HARYANTO, S.H.', 'AIPDA', '-', 'danregu', 2, 4),
('franciskus.goktua', '${defaultPass}', 'FRANCISKUS GOKTUA S', 'BRIPKA', '-', 'anggota', 2, 4),
('adi.tengah', '${defaultPass}', 'ADI', 'AIPTU', '-', 'danregu', 2, 5),
('yanuar.tengah', '${defaultPass}', 'YANUAR', 'BRIPDA', '-', 'anggota', 2, 5),
('ruhinda.tengah', '${defaultPass}', 'RUHINDA', 'AIPTU', '-', 'danregu', 2, 6),
('raja.putra', '${defaultPass}', 'RAJA PUTRA PERDANA', 'BRIPDA', '-', 'anggota', 2, 6),
('toha.barat', '${defaultPass}', 'TOHA', 'AIPTU', '-', 'danregu', 3, 7),
('alvin.barat', '${defaultPass}', 'ALVIN', 'BRIPTU', '-', 'anggota', 3, 7),
('nandi.barat', '${defaultPass}', 'NANDI', 'AIPTU', '-', 'danregu', 3, 8),
('adam.barat', '${defaultPass}', 'ADAM', 'BRIPTU', '-', 'anggota', 3, 8),
('indra.barat', '${defaultPass}', 'INDRA', 'AIPDA', '-', 'danregu', 3, 9),
('arizal.barat', '${defaultPass}', 'ARIZAL', 'BRIPDA', '-', 'anggota', 3, 9);
...
`;
    ...
    fs.writeFileSync('init_neon.sql', sql);
    console.log('init_neon.sql generated successfully.');
}
