...
app.config(['$routeProvider', '$httpProvider', function($routeProvider, $httpProvider) {
    $routeProvider
        ...
        .when('/dashboard', { templateUrl: 'views/dashboard.html?v=10', controller: 'DashboardCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/buat-laporan', { templateUrl: 'views/report-form.html?v=10', controller: 'ReportFormCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/pelimpahan', { templateUrl: 'views/handover-list.html?v=10', controller: 'HandoverCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/jadwal-piket', { templateUrl: 'views/schedule.html?v=10', controller: 'ScheduleCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/siaga-wiken', { templateUrl: 'views/siaga-wiken.html?v=10', controller: 'SiagaWikenCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/sop', { templateUrl: 'views/sop.html?v=10', controller: 'SOPCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/struktur', { templateUrl: 'views/org-chart.html?v=10', controller: 'OrgChartCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/users', { templateUrl: 'views/user-management.html?v=10', controller: 'UserManagementCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/kalender-libur', { templateUrl: 'views/holidays.html?v=10', controller: 'HolidayCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
