...
app.config(['$routeProvider', '$httpProvider', function($routeProvider, $httpProvider) {
    $routeProvider
        ...
        .when('/dashboard', { templateUrl: 'views/dashboard.html?v=9', controller: 'DashboardCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/buat-laporan', { templateUrl: 'views/report-form.html?v=9', controller: 'ReportFormCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/pelimpahan', { templateUrl: 'views/handover-list.html?v=9', controller: 'HandoverCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/jadwal-piket', { templateUrl: 'views/schedule.html?v=9', controller: 'ScheduleCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/siaga-wiken', { templateUrl: 'views/siaga-wiken.html?v=9', controller: 'SiagaWikenCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/sop', { templateUrl: 'views/sop.html?v=9', controller: 'SOPCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/struktur', { templateUrl: 'views/org-chart.html?v=9', controller: 'OrgChartCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/users', { templateUrl: 'views/user-management.html?v=9', controller: 'UserManagementCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
        .when('/kalender-libur', { templateUrl: 'views/holidays.html?v=9', controller: 'HolidayCtrl', resolve: { auth: ['$q', '$window', '$location', checkAuth] } })
